...
export class Backend implements backendInterface {
    ...
    async addFoodEntry(arg0: string, arg1: string, arg2: bigint, arg3: number, arg4: number, arg5: number, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async setDailyGoals(arg0: bigint, arg1: number, arg2: number, arg3: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setDailyGoals(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
